<%@ Page Title="" Language="C#" MasterPageFile="~/Hospitalpannel/hospitalpannel.master" AutoEventWireup="true" CodeFile="patientreport.aspx.cs" Inherits="Hospitalpannel_patientreport" %>
           ...
           <div class="form-group">
                ...
                <%--<input type="email" class="form-control" id="Doctorid">--%>
                 <%--<asp:TextBox runat="server" class="form-control" id="Doctorid"> </asp:TextBox>--%>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:doctorConnection %>" SelectCommand="SELECT tbappointment.Appointmentid, tbappointment.AppointmentTiming, tbappointment.appointmentdate, tbappointment.Userid, tbappointment.Doctorid, tbappointment.Patientname, tbappointment.Gender, tbappointment.Age, tbappointment.Symptomes, tbappointment.Appointmentstatus, tbdoctor.name, tbdoctor.address, tbdoctor.qualification, tbhospital_1.email, tbhospital_1.name AS Expr1, tbhospital_1.address AS Expr2 FROM tbappointment INNER JOIN tbdoctor ON tbappointment.Doctorid = tbdoctor.doctorid INNER JOIN tbhospital AS tbhospital_1 ON tbdoctor.hospitalid = tbhospital_1.hospitalid WHERE (tbappointment.appointmentdate = @appointmentdate) AND (tbappointment.Doctorid = @Doctorid)">
                      <SelectParameters>
