<%@ Page Title="" Language="C#" MasterPageFile="~/userpannel/User.master" AutoEventWireup="true" CodeFile="change password.aspx.cs" Inherits="userpannel_change_password" %>
           ...
           <%-- <form>--%>
            ...
            <%--   <button type="submit" class="">Send</button>--%>
              ...
              <asp:Button runat="server" class="" ID="button1" Text="Change" OnClick="button1_Click" ValidationGroup="news" />
                  <asp:Button runat="server" class="" ID="buttin2" Text="Remove" OnClick="buttin2_Click" ValidationGroup="news" />
                  </div>
